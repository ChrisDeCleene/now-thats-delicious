...
exports.editStore = async (req, res) => {
  ...
  // 2. confirm they are the ownder of the store
...
exports.updateStore = async (req, res) => {
  ...
  // Without this, we will not be able to use for near us location data later on
  ...
  req.flash(
    "success",
    `Successfully updates <strong>${store.name}</strong>. <a href="/stores/${store.slug}">View Store</a>`
  );
